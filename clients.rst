 ...
 * listen() – запустить ожидание распознавания речи. По окончанию возникает событие с listeter либо **voice_success** либо **voice_error**. Распознанная строка лежит в _data в **voice_result**
 ...
 * **onRecognitionListenerResult** - общее событие распознавания речи. Возникает когда процесс распознавания запустился не из экрана узла, а либо из фона либо из общего экрана(меню)
