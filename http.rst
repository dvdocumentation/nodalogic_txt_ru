...
Назначение: запустить распознавание речи, если есть разрешение RECORD_AUDIO. По результату возникает либо соыбтие voice_success либо voice_error, результат распознавания кладется в voice_result
